 ...
 * значение характеристики. Характеристика может рассматриваться как тип, аналог класса.
 * Характеристика содержит одну строку и «0» или несколько дескрипторов.
 *
 ...
 * Сервис - это единица для характеристики.
 *
 *
 ...
 *      -- Получить информацию об устройстве (Характеристика, имеет свой UUID, свойство - чтение)
 *      -- Получить информацию о производителе (Характеристика, имеет свой UUID, свойство - чтение)
 *      -- Получить информацию о софте (Характеристика, имеет свой UUID, свойство - чтение)
 *
 ...
 * 4) Смартфон производит запись, чтение данных от датчика, запускает нотификацию
 * 5) Работа происходит до тех пор пока смартфон не отключит соединение или не оборвётся соединение.
 *
 * */
