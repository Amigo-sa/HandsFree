    ...
    public void onClickBtnGreen() {
        ...
        switch (opMode) {
            ...
            case Bt2Bt:
                switch (callerState) {
                    case PhaseZero:
                        if (setCallerState(callerState, CallerState.DebugLoop)) {for (IDebugCtrl l : iDebugs) l.startDebug(); return;}
                        else break;
                    default:
    ...
    public void onClickBtnRed() {
        ...
        switch (opMode) {
            ...
            case Bt2Bt:
                switch (callerState) {
                    case DebugLoop:
                        if (setCallerState(callerState, CallerState.PhaseZero)) {for (IDebugCtrl l : iDebugs) l.stopDebug(); return;}
                        else break;
                    default:
