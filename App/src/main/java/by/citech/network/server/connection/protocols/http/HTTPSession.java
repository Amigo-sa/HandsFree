...
public class HTTPSession implements IHTTPSession {
        ...
        try {
            ...
            for (int boundaryIdx = 0; boundaryIdx < boundaryIdxs.length - 1; boundaryIdx++) {
                ...
                if (mpline == null || !mpline.contains(contentType.getBoundary())) {
                    throw new ResponseException(Status.BAD_REQUEST, "BAD REQUEST: Content type is multipart/form-data but chunk does not build with boundary.");
                }
    ...
    /**
     * Find the byte positions where multipart boundaries build. This reads a
    ...
    private int[] getBoundaryPositions(ByteBuffer b, byte[] boundary) {
        ...
        do {
            ...
            // Copy the end of the buffer to the build
