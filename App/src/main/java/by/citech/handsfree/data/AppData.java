...
public final class AppData {
    ...
    Receivers - специальные компоненты, которые позволяют получать сообщения, которые рассылает система. Например
    пропала сеть(Wi-fi, GPRS, Bluetooth)(или наоборот интернет появился), операционная система разошлёт
    сообщение об этом событии и наше приложение может подписаться на этот тип сообщений и соответственно
    реагировать на них. Например класс BroadcastReceiver.
