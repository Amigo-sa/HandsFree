...
public class Tags {
    ...
    public static final String ServerCtrlNanoWebSocket = "WSD_ServerCtrl";
    ...
    public static final String FROM_AUDIN          = "WSD_4AUDIN";
    public static final String TO_NET              = "WSD_2NET";

    public static final String AUDIN2BT_LOOPER     = "WSD_AUDIN2BT_LOOPER";
    ...
    public static final String BT2AUDOUT_LOOPER    = "WSD_BT2AUD_LOOPER";
    public static final String AUDIN2AUDOUT_LOOPER = "WSD_AUDIN2AUDOUT_LOOPER";
