...
public class Tags {
    ...
    public static final String CLT_TASK_SEND        = "WSD_CLT_TASK_SEND";
    ...
    public static final String CLT_STREAM_BLUETOOTH = "WSD_CLT_STREAM_BT";
    public static final String CLT_STORE_BT2NET     = "WSD_CLT_STORE_BT2NET";
